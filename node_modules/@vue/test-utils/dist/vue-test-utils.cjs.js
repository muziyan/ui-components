...
function isLegacyExtendedComponent(component) {
    ...
    var fakeCmp = Vue__namespace.extend({});
...
var createStub = function (_a) {
    ...
    var render = function (ctx) {
        return Vue.h(tag, ctx.$props, renderStubDefaultSlot ? ctx.$slots : undefined);
    };
    ...
    return {
        created: function () {
            ...
            for (var _i = 0, _b = Object.entries(data); _i < _b.length; _i++) {
                ...
                Vue.getCurrentInstance().data = Vue.reactive(__assign(__assign({}, Vue.getCurrentInstance().data), (_a = {}, _a[k] = v, _a)));
            }
        }
    };
};
...
function mount(originalComponent, options) {
    ...
    function slotToFunction(slot) {
        ...
        if (typeof slot === 'string') {
            ...
            if (isHTML(slot)) {
                return function (props) { return Vue.h(processSlot(slot), props); };
            }
